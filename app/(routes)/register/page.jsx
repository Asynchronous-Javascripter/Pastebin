...
export default function Register() {
  ...
  if (isMounded !== true) {
    return (
      <div className="login-box-skeleton relative w-[340px] h-[470px] left-2 top-10 loading_animation rounded-md"></div>
    );
  }
  ...
  return (
    <Card className="w-[340px] relative left-2 top-10 h-[470px]">
      <CardHeader>
